...
(function () {
  ...
  var DOC =
    ...
    '<hr class="dc-rule">' +
    '<h3>Positioning</h3>' +
    '<p>The acoustic handpan is producing genuinely new knowledge, and Neotone has a unique view of it, because it rebuilt the instrument in another medium. That view runs in two directions. Neotone can articulate knowledge that is valuable to players and makers of the acoustic instrument, and it can extend that field&rsquo;s values into electronic music. The position is a new frame, not a variation on any established frame. &ldquo;Digital handpan,&rdquo; an electronic translation of an acoustic instrument, has turned out to be too limited to describe what the company creates. So has &ldquo;MIDI controller,&rdquo; and so has &ldquo;experimental new interface.&rdquo;</p>' +
    ...
    '<p>The knowledge itself is cloaked in materiality and alchemy. The origin myth of music theory has Pythagoras walking past a blacksmith&rsquo;s shop and hearing the harmonic ratios in the hammers. The myth describes a physical impossibility, since metal is inharmonic. A handpan is a piece of metal into which a fundamental and its harmonics are hammered by hand, which puts it, completely literally, at the junction where that myth founded music theory and alchemy both. Its knowledge is inseparable from its material.</p>' +
    '<p>And it sounds good immediately when an absolute beginner plays it, while also having a very high ceiling for developing advanced skill, a combination that is powerful and rare in any instrument. This is an experiential opening into established musical traditions, and importantly, not only into the Western tradition where this instrument originated.</p>' +
    '<p>Neotone&rsquo;s view comes first from translation. Rebuilding the handpan in an electronic medium was a study of the acoustic instrument that is different from the study makers or players undertake. It created knowledge of a different sort: about gestures of the hand, about how one note changes with the position and force of a strike. And the instrument that came out of it, while of exceptionally high craftsmanship, is, crucially, not a handpan. Its body is made of wood rather than metal, and significantly, it also reaches directly into electronic music culture.</p>' +
    '<p>Neotone&rsquo;s adopters have followed the same line. The first customers were professional acoustic handpan players; the instrument now increasingly reaches DJs and electronic musicians, and the overlap opens a larger opportunity for learners, since it works equally well whether the entry point is sound design, electronic production, or instrumental technique. What Neotone offers is a way into a craft-rich practice, a way of belonging to that kind of pursuit, that is not offered in exactly the same form anywhere else. Neotone is not competing on features or specs, it is offering an otherwise unrepresented entry point into music.</p>' +
    '<p>All of this is invisible if the instrument is read at first glance as a digital handpan, or a controller, or a cool new boutique instrument. This perception cannot be interrupted through marketing headlines or product copy. It can only be interrupted by establishing a place to locate this emerging craft discourse. No individual handpan maker can own that discourse, Neotone included. Neotone&rsquo;s position to host it, and to embody and extend it in a singular way, is the principle underneath the design.</p>' +
    '<hr class="dc-rule">' +
    '<h3>Tonefield</h3>' +
    '<p>To accomplish this, the site introduces an editorial layer, at the highest level of navigation, alongside its instrument. We named this publication <a href="tonefield.html"><em>Tonefield</em></a>, after the surface of the instrument that meets the player&rsquo;s hand.</p>' +
    '<p>Its pieces pass a filter: they must be of value to a reader who does not necessarily own a Neotone instrument. That&rsquo;s what distinguishes the writing from a product blog. The pieces are edited and curated, not chronologically posted, and they are not conceived as &ldquo;content&rdquo; generated to fill a pre-existing space. This project is creating a new space with new material, something that will invite contribution and that reads somewhere between an art and culture magazine and a trade journal. Neotone&rsquo;s instrument may be a point of access into many of these ideas, but it is not their subject.</p>' +
    '<hr class="dc-rule">' +
    ...
    '<p>&ldquo;Neotone&rdquo; is the container for the instrument and the knowledge, so the wordmark is a masthead rather than a link, and the top level navigation is focused to its highest value outputs: Instruments and Tonefield. &ldquo;Instruments&rdquo; is plural solely to explore how the structure holds as Neotone develops additional products. Beneath those two words the site keeps the same separation of purposes. Tonefield has a container page and its <a href="neos-note-names.html">articles</a>. <a href="updates.html">Updates</a> has a container of its own, for the mailing list archive, which carries dates where Tonefield does not. And there is a small set of utility pages: a <a href="brief.html">Brief</a>, which gives the company at a glance without the product framing of a FAQ, and contact and <a href="legal.html">legal</a>, which are pure utility.</p>' +
